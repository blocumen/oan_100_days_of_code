...
public class GetSetRuleTest {
    ...
    public static void deployDapp() {
        ...
        byte[] dapp = avmRule.getDappBytes(example.GetSet.class, null);
    ...
    public void testSetString() {
        ...
        // 2- make the call;
        byte[] txData = ABIUtil.encodeMethodArguments("setMyInt","Hello Alice");
    ...
    public void testGetString() {
        ...
        // 1- encode method name and arguments
        // 2- make the call;
        byte[] txData = ABIUtil.encodeMethodArguments("getStr");
        AvmRule.ResultWrapper result = avmRule.call(from, dappAddr, BigInteger.ZERO, txData);
